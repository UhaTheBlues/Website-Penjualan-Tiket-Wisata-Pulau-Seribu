      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <!-- notif -->
            <?php 
             $order_notif = DB::table('order')->where('notif','=',"")->orderBy('updated_at', 'DESC')->orWhereNull('notif')->get();
            ?>
            <li class="nav-item dropdown">
              <a class="nav-link" id="notifdropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <i class="mdi mdi mdi-bell menu-icon"></i><span class="badge badge-pill badge-danger">{{ count($order_notif) }}</span>
              </a>
              <div class="dropdown-menu dropdown-menu-xl navbar-dropdown" aria-labelledby="notifdropdown" style="width: 250px; height: 200px; overflow-y: scroll;">
                

              <!-- List group -->
                <div class="list-group list-group-flush">
                  @foreach($order_notif as $key)
                  <a href="{{ route('admin.transaksi.detail',['id'=>$key->id]) }}" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            
                            <h4 class="mb-0 text-sm">#{{$key->invoice}}</h4>
                          </div>
                          <div class="text-right text-muted">
                          </div>
                        </div><?php
                        $text="";
                        if($key->status_order_id == 1){
                          $text="Baru";
                        }
                        elseif($key->status_order_id == 2){
                          $text="Terbayarkan";
                        }?>
                        <p class="text-sm mb-0">Pesanan {{$text}}, Klik untuk cek!</p>
                      </div>
                    </div>
                  </a>
                  @endforeach
                  @if(count($order_notif) == 0)
                  <a href="" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col ml--2">
                        <p class="text-sm mb-0">Tidak Ada Notifikasi</p>
                      </div>
                    </div>
                  </a>
                  @endif
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Admin PulauKuy</p>
                </div>
              </a>
          ...
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">PulauKuy</span>
            ...
            <li class="nav-item ">
              <a class="nav-link" data-toggle="collapse" href="#ui-basic1" aria-expanded="false" aria-controls="ui-basic1">
                <span class="menu-title">Data Paket Wisata</span>
           ...
           <!--  <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.metode') }}">
                <span class="menu-title">Metode IBCF</span>
                <i class="mdi mdi mdi-account-multiple menu-icon"></i>
              </a>
            </li>
          </ul> -->
           ...
           <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.kuis') }}">
                <span class="menu-title">Edit Kuis</span>
                <i class="mdi mdi mdi-account-multiple menu-icon"></i>
              </a>
            </li>
          </ul>
...
<!--     @foreach($order_notif as $key)
    <script type="text/javascript">
      $(showtext).append('<a href="{{ route('admin.transaksi.detail',['id'=>$key->id]) }}" class="list-group-item list-group-item-action"><div class="row align-items-center"><div class="col ml--2"><div class="d-flex justify-content-between align-items-center"><div><h4 class="mb-0 text-sm">#{{$key->invoice}}</h4></div><div class="text-right text-muted"></div></div><p class="text-sm mb-0">Pesanan Terbayarkan, Klik untuk cek!</p></div></div></a>');
    </script>
    @endforeach -->
