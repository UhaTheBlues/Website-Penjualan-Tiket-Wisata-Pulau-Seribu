                  ...
                  <div class="card-body">
                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <!--    <td>Email</td>-->
                        <!--    <td>:</td>-->
                        <!--    <td class="p-2">{{ $order->email_pelanggan }}</td>-->
                        <!--</tr>-->
                        <tr>
                            <td>Email</td>
                            <td>:</td>
                            <td  class="p-2">
                            <form action="{{ route('admin.transaksi.inputresi',['id' => $order->id]) }}" method="POST"><br>
                                @csrf
                            <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm" placeholder="Kirim Email" aria-label="Recipient's username" aria-describedby="basic-addon2" name="no_resi" value="{{ $order->email_pelanggan }}" required>
