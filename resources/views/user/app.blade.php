...
<html lang="en">
  <head>
    <title>PULAU KUY &mdash; PAKET WISATA </title>
    <meta charset="utf-8">
    ...
    <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"
     ...
     crossorigin=""></script>
     <link rel="shortcut icon" type="image/jpg" href="{{ asset('public/images/favicon.ico') }}"/>
                        ...
                        <li>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{ route('user.profile') }}">Pengaturan Akun</a>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jalan jatiwaringin raya</li>
                <li class="phone"><a href="tel://23923929210">+62 3392 3929 210</a></li>
                <li class="email">pulaukuy@gmail.com</li>
              </ul>
            </div>
