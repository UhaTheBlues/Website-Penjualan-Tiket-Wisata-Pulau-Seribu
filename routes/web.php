...
Route::get('/metode_ibcf','user\WelcomeController@metode_ibcf')->name('metode_ibcf');
...
Route::get('/virtualtour','user\PetaController@index')->name('peta');
...
Route::group(['middleware' => ['auth','checkRole:admin']],function(){    
    ...
    Route::get('/admin/transaksi/exportexcel','admin\TransaksiController@exportExcel');
    Route::get('/admin/transaksi/exportpdf','admin\TransaksiController@exportPdf');
    ...
    // metode
    Route::get('/admin/metode','admin\MetodeController@index')->name('admin.metode');
    //Kuis
    Route::get('/admin/kuis', 'admin\KuisController@index')->name('admin.kuis');
...
Route::group(['middleware' => ['auth','checkRole:customer']],function(){
    ...
    Route::post('/order/insertrating/','user\OrderController@insertrating')->name('user.order.insertrating');

    Route::get('/profile','user\ProfileController@detail')->name('user.profile');
    
    // Route::get('/editProfile','user\ProfileController@update')->name('user.editProfile');
    // Route::post('/order/detail/{id}','user\OrderController@review')->name('user.order.detail.review');
    Route::post('/user/profile/update/{id}','user\ProfileController@update')->name('user.profile.update');
});
